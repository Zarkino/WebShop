...
function banner2() {
    echo '<ul class="bar" style="margin: 0 -50px 0 -50px; width:calc(100% + 100px)">';
        ...
        if(isset($_SESSION['cart']) && sizeof($_SESSION['cart']) > 0) {
            echo '<a href="cart.php?id=">'.sizeof($_SESSION['cart']).'</a>';
        }
        echo '<input type="image" src="../Icons/Cart.svg" alt="Cart" style="filter:invert(1); vertical-align: middle; padding: 3px 0 0 5px;" height="35px" onclick="window.location = \'cart.php\';"></li>';
